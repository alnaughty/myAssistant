...
import 'package:myassistant1/pages/BudgetAddEI.dart';
import 'package:myassistant1/pages/BudgetHistory.dart';
import 'package:myassistant1/pages/BudgetPerCat.dart';
import 'package:myassistant1/pages/HistoryShow.dart';
import 'package:myassistant1/pages/LoginPage.dart';
import 'package:myassistant1/pages/RecurrentBudgets.dart';
...
class BudgetStatus extends StatefulWidget {
  var name;
  BudgetStatus(this.name);
  @override
  _budgetState createState() => new _budgetState();
}

class _budgetState extends State<BudgetStatus> {
                      ...
                      child: IconButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              new PageTransition(
                                  child: BudgetHistory(widget.name),
